...
export type I8u6b4qqnpk6kt = Array<{
    "phase": Phase;
    "event": Anonymize<Ie7hiemamv7lef>;
...
export type Ie7hiemamv7lef = AnonymousEnum<{
    "System": Anonymize<I2bb113u099ocf>;
    "Scheduler": Anonymize<Inhjjepfvlklu>;
    ...
    "Whitelist": Anonymize<I3s5tr26939m72>;
    "Claims": CommonClaimsEvent;
    "Vesting": Anonymize<I7uu9ebnucfti5>;
    "Utility": Anonymize<I3dudt1tmqpfru>;
    "Proxy": Anonymize<Ic4dp2dghasped>;
    "Multisig": Anonymize<Iap97v99fagi08>;
    ...
    "FastUnstake": Anonymize<I2ulfnfkqnbhuu>;
    "DelegatedStaking": Anonymize<I1nq1se98idofq>;
    "StakingAhClient": Anonymize<Ia2qt1td4jn9en>;
    ...
    "Crowdloan": Anonymize<I3oom17k08c8et>;
    ...
    "Sudo": Anonymize<Ie0312ok78brgt>;
    "RcMigrator": Anonymize<Ib7hkc3hfr4220>;
}>;
export type I2bb113u099ocf = AnonymousEnum<{
    /**
     ...
     * An extrinsic failed.
     */
    "ExtrinsicFailed": Anonymize<Iesv1i2apo2r1g>;
    /**
     * `:code` was updated.
     */
     ...
     */
    "RejectedInvalidAuthorizedUpgrade": Anonymize<I53cu3s3lklru9>;
}>;
...
export type Iesv1i2apo2r1g = {
    "dispatch_error": Anonymize<I7obqmr5splru6>;
    "dispatch_info": Anonymize<Ic9s8f85vjtncc>;
};
export type I7obqmr5splru6 = AnonymousEnum<{
    "Other": undefined;
    ...
    "Module": Enum<{
        ...
        "RcMigrator": Anonymize<Ifbstgi0q3nbq3>;
    }>;
...
export type Ifbstgi0q3nbq3 = AnonymousEnum<{
    "Unreachable": undefined;
     ...
     */
    "UnsignedValidationFailed": undefined;
}>;
...
export type I53cu3s3lklru9 = {
    "code_hash": FixedSizeBinary<32>;
    "error": Anonymize<I7obqmr5splru6>;
};
export type Inhjjepfvlklu = AnonymousEnum<{
    /**
     * Scheduled some task.
     */
     ...
     */
    "Dispatched": Anonymize<Iahsemhu3i038s>;
    /**
...
export type I3s5tr26939m72 = AnonymousEnum<{
    "CallWhitelisted": Anonymize<I1adbcfi5uc62r>;
    "WhitelistedCallRemoved": Anonymize<I1adbcfi5uc62r>;
    "WhitelistedCallDispatched": Anonymize<I3a5ue7ht52g19>;
}>;
export type I1adbcfi5uc62r = {
    "call_hash": FixedSizeBinary<32>;
};
export type I3a5ue7ht52g19 = {
    "call_hash": FixedSizeBinary<32>;
    "result": Anonymize<I7qdmdulcmrtug>;
};
export type I7qdmdulcmrtug = ResultPayload<Anonymize<Ia1u1r3n74r13c>, {
...
export type I3dudt1tmqpfru = AnonymousEnum<{
    /**
     * Batch of dispatches did not complete fully. Index of first failing dispatch given, as
     * well as the error.
     */
    "BatchInterrupted": Anonymize<I4e66e7e50p7np>;
    /**
     ...
     */
    "ItemFailed": Anonymize<Ibc6sq48uaul5r>;
    /**
     * A call was dispatched.
     */
    "DispatchedAs": Anonymize<I3eqcdml0b2mpq>;
    /**
     ...
     */
    "IfElseFallbackCalled": Anonymize<Ibsu1aspdgvvnc>;
}>;
export type I4e66e7e50p7np = {
    "index": number;
    "error": Anonymize<I7obqmr5splru6>;
};
export type Ibc6sq48uaul5r = {
    "error": Anonymize<I7obqmr5splru6>;
};
export type I3eqcdml0b2mpq = {
    "result": Anonymize<Ififji6vretg90>;
};
export type Ibsu1aspdgvvnc = {
    "main_error": Anonymize<I7obqmr5splru6>;
};
export type Ic4dp2dghasped = AnonymousEnum<{
    /**
     * A proxy was executed correctly, with the given.
     */
    "ProxyExecuted": Anonymize<I3eqcdml0b2mpq>;
    /**
     * A pure account has been created by new proxy with given
     * disambiguation index and proxy type.
     */
    "PureCreated": Anonymize<I1o6rk06ad7vtv>;
    /**
...
export type Iap97v99fagi08 = AnonymousEnum<{
    /**
     ...
     */
    "MultisigExecuted": Anonymize<Ies5bv0ec8c0jt>;
    /**
...
export type I2ulfnfkqnbhuu = AnonymousEnum<{
    /**
     * A staker was unstaked.
     */
    "Unstaked": Anonymize<Ic42tjirnh5g0f>;
    /**
...
export type Ia2qt1td4jn9en = AnonymousEnum<{
    /**
     ...
     */
    "Unexpected": Anonymize<Ib22de21ajklii>;
}>;
...
export type Ib22de21ajklii = AnonymousEnum<{
...
export type I3oom17k08c8et = AnonymousEnum<{
    /**
     ...
     */
    "HandleBidResult": Anonymize<I6uek3npqtsii1>;
    /**
...
export type Ie0312ok78brgt = AnonymousEnum<{
    /**
     * A sudo call just took place.
     */
    "Sudid": Anonymize<I491elg0m8mkcl>;
    /**
     ...
     */
    "SudoAsDone": Anonymize<I491elg0m8mkcl>;
}>;
export type I491elg0m8mkcl = {
    /**
     * The result of the call made by the sudo user.
     */
    "sudo_result": Anonymize<Ififji6vretg90>;
};
...
export type Ib7hkc3hfr4220 = AnonymousEnum<{
    /**
     ...
     */
    "ManagerMultisigDispatched": Anonymize<I5co3qaiqq2b3a>;
    /**
     * The manager multisig received a vote.
     */
    "ManagerMultisigVoted": Anonymize<I67kf0a73jrb5s>;
    /**
     * The migration settings were set.
     */
    "MigrationSettingsSet": Anonymize<I3gfvfi6vikc5t>;
}>;
...
export type I1t55ojifgnq64 = AnonymousEnum<{
    ...
    "ClaimsMigrationOngoing": {
        "current_key"?: (Enum<{
            ...
            "Claims"?: (FixedSizeBinary<20>) | undefined;
            "Vesting"?: (FixedSizeBinary<20>) | undefined;
            "Signing"?: (FixedSizeBinary<20>) | undefined;
...
export type I5co3qaiqq2b3a = {
    "res": Anonymize<Ififji6vretg90>;
};
export type I67kf0a73jrb5s = {
    "votes": number;
};
export type I3gfvfi6vikc5t = {
    /**
     * The old migration settings.
     */
    "old"?: Anonymize<Idfnpbvgc91m92>;
    /**
     * The new migration settings.
     */
    "new"?: Anonymize<Idfnpbvgc91m92>;
};
export type Idfnpbvgc91m92 = (Anonymize<I7hcg2ag6ofoah>) | undefined;
export type I7hcg2ag6ofoah = {
    "max_accounts_per_block"?: Anonymize<I4arjljr6dpflb>;
    "max_items_per_block"?: Anonymize<I4arjljr6dpflb>;
};
...
export type Ib38l2lo53mgqe = AnonymousEnum<{
    "System": Anonymize<Iekve0i6djpd9f>;
    "Scheduler": Anonymize<If7f1oi0lnntd3>;
    ...
    "Whitelist": Anonymize<I57bo8ek0irfer>;
    "Claims": Anonymize<Id0dj18ct09hlp>;
    "Vesting": Anonymize<Icgf8vmtkbnu4u>;
    "Utility": Anonymize<Id2q4onhe21af5>;
    "Proxy": Anonymize<I7efln0g9svbsj>;
    "Multisig": Anonymize<I99ff0eekmer28>;
    ...
    "Sudo": Anonymize<I3h779cf0cfb88>;
    "RcMigrator": Anonymize<Iebj32kmumqrl>;
}>;
...
export type If7f1oi0lnntd3 = AnonymousEnum<{
    /**
     * Anonymously schedule a task.
     */
    "schedule": Anonymize<I5ierr6903vdvf>;
    /**
     ...
     */
    "schedule_named": Anonymize<If6sasuaqu2tmb>;
    /**
     ...
     */
    "schedule_after": Anonymize<I47cjnq1oftng7>;
    /**
     * Schedule a named task after a delay.
     */
    "schedule_named_after": Anonymize<I9bbm8firn6qup>;
    /**
...
export type I5ierr6903vdvf = {
    "when": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
    "call": TxCallData;
};
export type If6sasuaqu2tmb = {
    "id": FixedSizeBinary<32>;
    "when": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
...
export type I47cjnq1oftng7 = {
    "after": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
    "call": TxCallData;
};
export type I9bbm8firn6qup = {
    "id": FixedSizeBinary<32>;
    "after": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
...
export type I57bo8ek0irfer = AnonymousEnum<{
    ...
    "dispatch_whitelisted_call_with_preimage": Anonymize<I2r9m4irmlvj71>;
}>;
...
export type Id2q4onhe21af5 = AnonymousEnum<{
    /**
     ...
     * event is deposited.
     */
    "batch": Anonymize<Ie8a58pmgvlq4f>;
    /**
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "as_derivative": Anonymize<I30mhj07m9ivqe>;
    /**
     ...
     * - O(C) where C is the number of calls to be batched.
     */
    "batch_all": Anonymize<Ie8a58pmgvlq4f>;
    /**
     ...
     * - O(1).
     */
    "dispatch_as": Anonymize<Ieib6bnnn47boo>;
    /**
     * Send a batch of dispatch calls.
     ...
     * - O(C) where C is the number of calls to be batched.
     */
    "force_batch": Anonymize<Ie8a58pmgvlq4f>;
    /**
     ...
     * The dispatch origin for this call must be _Root_.
     */
    "with_weight": Anonymize<Ics663bmm5cebq>;
    /**
     ...
     * or both.
     */
    "if_else": Anonymize<I23ohudfs9tnn3>;
    /**
     * Dispatches a function call with a provided origin.
     *
     ...
     * The dispatch origin for this call must be _Root_.
     */
    "dispatch_as_fallible": Anonymize<Ieib6bnnn47boo>;
}>;
export type Ie8a58pmgvlq4f = {
    "calls": Array<TxCallData>;
};
export type I30mhj07m9ivqe = {
    "index": number;
    "call": TxCallData;
};
export type Ieib6bnnn47boo = {
    "as_origin": Anonymize<Icqnsdsc2kqh8a>;
    "call": TxCallData;
};
export type Ics663bmm5cebq = {
    "call": TxCallData;
    "weight": Anonymize<I4q39t5hn830vp>;
};
export type I23ohudfs9tnn3 = {
    "main": TxCallData;
    "fallback": TxCallData;
};
export type I7efln0g9svbsj = AnonymousEnum<{
    /**
     ...
     */
    "proxy": Anonymize<Ifimilutffv1hd>;
    /**
     ...
     * - `call`: The call to be made by the `real` account.
     */
    "proxy_announced": Anonymize<I95t51lu8mkt40>;
    /**
...
export type I95t51lu8mkt40 = {
    "delegate": MultiAddress;
    "real": MultiAddress;
    "force_proxy_type"?: Anonymize<I2d3p1op89707u>;
    "call": TxCallData;
};
export type I99ff0eekmer28 = AnonymousEnum<{
    /**
     ...
     */
    "as_multi_threshold_1": Anonymize<If4agt6u1hp5ik>;
    /**
     ...
     */
    "as_multi": Anonymize<Iflotpgpk028eg>;
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
     * approved by a total of `threshold - 1` of `other_signatories`.
     *
...
export type If4agt6u1hp5ik = {
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "call": TxCallData;
};
export type Iflotpgpk028eg = {
    "threshold": number;
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
...
export type Idrvp50hbkv2k2 = {
    "equivocation_proof": {
        ...
        "ancestry_proof": {
            ...
            "leaf_count": bigint;
            "items": Array<Anonymize<Idsa6q9es8ufjv>>;
        };
...
export type I3h779cf0cfb88 = AnonymousEnum<{
    /**
     * Authenticates the sudo key and dispatches a function call with `Root` origin.
     */
    "sudo": Anonymize<I2r9m4irmlvj71>;
    /**
     * Authenticates the sudo key and dispatches a function call with `Root` origin.
     * This function does not check the weight of the call, and instead allows the
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "sudo_unchecked_weight": Anonymize<Ics663bmm5cebq>;
    /**
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    "sudo_as": Anonymize<Ianeigkpiu90i5>;
    /**
...
export type Ianeigkpiu90i5 = {
    "who": MultiAddress;
    "call": TxCallData;
};
export type Iebj32kmumqrl = AnonymousEnum<{
    /**
     ...
     */
    "vote_manager_multisig": Anonymize<I5lh1leb7ajd0i>;
    /**
     * Set the migration settings. Can only be done by admin or manager.
     */
    "set_settings": Anonymize<I6j3ej8fb1sdg>;
}>;
...
export type I6j3ej8fb1sdg = {
    "settings"?: Anonymize<Idfnpbvgc91m92>;
};
...
export type Ibokoa76g2r5np = ResultPayload<Anonymize<Ififji6vretg90>, Anonymize<I5nrjkj9qumobs>>;
...
export type Iaeskil8f21sqj = ResultPayload<{
    "execution_result": Anonymize<I7qdmdulcmrtug>;
    "emitted_events": Anonymize<Icdm0sifv1p6og>;
    "local_xcm"?: (XcmVersionedXcm) | undefined;
    "forwarded_xcms": Anonymize<Ialhmrpub9sefe>;
}, Anonymize<I55ku9c5gk50hb>>;
export type Icdm0sifv1p6og = Array<Anonymize<Ie7hiemamv7lef>>;
export type Ialhmrpub9sefe = Array<[XcmVersionedLocation, Array<XcmVersionedXcm>]>;
export type I55ku9c5gk50hb = AnonymousEnum<{
    "Unimplemented": undefined;
    "VersionedConversionFailed": undefined;
}>;
export type I3i05j3bv90mlk = ResultPayload<{
