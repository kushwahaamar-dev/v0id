...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I8u6b4qqnpk6kt>, false, never>;
        /**
    ...
    RcMigrator: {
         ...
         */
        ManagerMultisigs: StorageDescriptor<[Key: Anonymize<Ib38l2lo53mgqe>], Anonymize<Ia2lhg7l2hilo3>, false, never>;
        /**
...
type ICalls = {
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<I5ierr6903vdvf>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<If6sasuaqu2tmb>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I47cjnq1oftng7>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I9bbm8firn6qup>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I2r9m4irmlvj71>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ie8a58pmgvlq4f>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I30mhj07m9ivqe>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ie8a58pmgvlq4f>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Ieib6bnnn47boo>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ie8a58pmgvlq4f>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Ics663bmm5cebq>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<I23ohudfs9tnn3>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<Ieib6bnnn47boo>>;
    };
    Proxy: {
        /**
         ...
         */
        proxy: TxDescriptor<Anonymize<Ifimilutffv1hd>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I95t51lu8mkt40>>;
        /**
    ...
    Multisig: {
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<If4agt6u1hp5ik>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Iflotpgpk028eg>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I2r9m4irmlvj71>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Ics663bmm5cebq>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<Ianeigkpiu90i5>>;
        /**
    ...
    RcMigrator: {
         ...
         */
        vote_manager_multisig: TxDescriptor<Anonymize<I5lh1leb7ajd0i>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Iesv1i2apo2r1g>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<I53cu3s3lklru9>>;
    };
    Scheduler: {
        /**
         * Scheduled some task.
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<Iahsemhu3i038s>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<I3a5ue7ht52g19>>;
    };
    Claims: {
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I4e66e7e50p7np>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Ibc6sq48uaul5r>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I3eqcdml0b2mpq>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<Ibsu1aspdgvvnc>>;
    };
    Proxy: {
        /**
         * A proxy was executed correctly, with the given.
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I3eqcdml0b2mpq>>;
        /**
         * A pure account has been created by new proxy with given
         * disambiguation index and proxy type.
         */
        PureCreated: PlainDescriptor<Anonymize<I1o6rk06ad7vtv>>;
        /**
    ...
    Multisig: {
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Ies5bv0ec8c0jt>>;
        /**
    ...
    FastUnstake: {
         ...
         */
        Unstaked: PlainDescriptor<Anonymize<Ic42tjirnh5g0f>>;
        /**
    ...
    Crowdloan: {
         ...
         */
        HandleBidResult: PlainDescriptor<Anonymize<I6uek3npqtsii1>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<I491elg0m8mkcl>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<I491elg0m8mkcl>>;
    };
    RcMigrator: {
        /**
         ...
         */
        ManagerMultisigDispatched: PlainDescriptor<Anonymize<I5co3qaiqq2b3a>>;
        /**
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<Ib38l2lo53mgqe>, proxy_type: Anonymize<Icbk7p926ddukn>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Ibokoa76g2r5np>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ib38l2lo53mgqe>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ib38l2lo53mgqe>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<Icqnsdsc2kqh8a>, call: Anonymize<Ib38l2lo53mgqe>, result_xcms_version: number], Anonymize<Iaeskil8f21sqj>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I3i05j3bv90mlk>>;
    };
    /**
...
export type DotDispatchError = Anonymize<I7obqmr5splru6>;
...
export type DotCallData = Anonymize<Ib38l2lo53mgqe> & {
    value: {
        type: string;
    };
};
